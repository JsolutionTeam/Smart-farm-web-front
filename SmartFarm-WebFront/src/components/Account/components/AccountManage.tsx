...
import {AccountManageTypes} from "@typedef/components/Site/account.types";
...
type Props = {
    ...
    msgs: { username: string, siteSeq: string };
    insert: () => Promise<void>;
    update: () => Promise<void>;
};
...
const AccountManage = ({
    ...
    const siteSeqRef = useRef<HTMLInputElement | null>(null);
